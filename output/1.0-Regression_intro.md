...
@tbl-assumptions presents a summary of the model assumptions,
...
model](/Users/DidierBrassard/Documents/_Postdoctorat/Workshops/CodingClub_workshop/output/1.0-Regression_intro_files/figure-gfm/fig-normal-1.png)
...
![Homoscedasticity assumption (constant variance of errors) in linear
regression
model](/Users/DidierBrassard/Documents/_Postdoctorat/Workshops/CodingClub_workshop/output/1.0-Regression_intro_files/figure-gfm/fig-variance-1.png)

@fig-lin shows assessment of the linearity assumption.

    ## `geom_smooth()` using formula = 'y ~ x'

![Linearity assumption (linear relationship between X and Y) in linear
regression
model](/Users/DidierBrassard/Documents/_Postdoctorat/Workshops/CodingClub_workshop/output/1.0-Regression_intro_files/figure-gfm/fig-lin-1.png)
