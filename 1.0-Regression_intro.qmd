...
which reads as: the expected value of outcome $Y$ for $i$^th^ individual equals to a constant $\beta_0$ (model intercept) plus the value of $X$ for the $i$^th^ individual multiplied by the regression coefficient $\beta_X$ and with errors $\epsilon$.
